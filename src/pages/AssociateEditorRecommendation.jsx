...
const AssociateEditorRecommendation = () => {
    ...
    useEffect(() => {
        const fetchAssociateEditorRecommendations = async () => {
            try {
                setLoading(true);
                setError(null);
        ...
        fetchAssociateEditorRecommendations();
    }, [journalId, navigate]);
        ...
        return (
            <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" minHeight="300px">
                ...
                >
                    ...
                    <Typography>
                        There are currently no associate editor recommendations available for this journal.
                    </Typography>
                </Alert>
                <Button 
                    variant="contained" 
...
export default AssociateEditorRecommendation;