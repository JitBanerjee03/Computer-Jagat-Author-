    ...
    <div style={{ marginLeft: '8%', marginRight: '8%' }}>
      <header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        ...
        <ul className='nav nav-pills'>
          ...
          <li className='nav-item'>
            <Link to={'/post-journal'} className={`nav-link ${activeLink === 'Post Journal' ? 'active' : ''}`} onClick={() => handleLinkClick('Post Journal')}>
              Post Journal
            </Link>
          </li>
          
          <li className='nav-item'>
            <Link to={'/submitted-article'} className={`nav-link ${activeLink === 'Article Archive' ? 'active' : ''}`} onClick={() => handleLinkClick('Article Archive')}>
              Article Archive
            </Link>
          </li>

          <li className='nav-item'>
            <Link to={'/account'} className={`nav-link ${activeLink === 'Account' ? 'active' : ''}`} onClick={() => handleLinkClick('Account')}>
              Account
            </Link>
          </li>
          
          <li className='nav-item'>
            <Link to={'/about'} className={`nav-link ${activeLink === 'About' ? 'active' : ''}`} onClick={() => handleLinkClick('About')}>
              About
            </Link>
          </li>
        </ul>
